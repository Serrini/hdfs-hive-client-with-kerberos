...
public class SaslRpcClient {
    ...
    private void sendSaslMessage(OutputStream out, RpcSaslProto message)
        ...
        System.out.println("token_byte_string:"+bytesToHexFun1(message.getToken().toByteArray()));
    ...
    class WrappedOutputStream extends FilterOutputStream {
        ...
        public void write(byte[] buf, int off, int len) throws IOException {
            ...
            System.out.println("before_wrap:-----------------------------------------------");
            System.out.println("write_buf_before_wrap:byte[]:"+bytesToHexFun1(buf));
            String bufStrBefore = new String(buf);
            System.out.println("write_buf_before_wrap:string:"+bufStrBefore);
            buf = saslClient.wrap(buf, off, len);
            System.out.println("after_wrap:-----------------------------------------------");
            String bufStrAfter = new String(buf);
            System.out.println("write_buf_after_wrap:byte[]:"+bytesToHexFun1(buf));
            System.out.println("write_buf_after_wrap:string:"+bufStrAfter);
